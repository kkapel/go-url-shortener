...
// Пустой запрос для получения URL пользователя.
// Объявлен отдельным типом (а не google.protobuf.Empty),
// чтобы можно было расширять без потери обратной совместимости.
...
const file_proto_shortener_proto_rawDesc = "" +
	...
	"\fListUserURLs\x12\x1e.shortener.ListUserURLsRequest\x1a\x1b.shortener.UserURLsResponseB!Z\x1fgo-url-shortener/internal/protob\beditionsp\xe8\a"
